...
|-------|-----------|-------------|
| `core` | `core-security.md`, `core-architecture.md`, `core-root-cause-analysis.md`, `core-code-quality.md`, `core-error-handling.md`, `core-testing.md`, `core-dependency-management.md`, `core-secure-defaults.md`, `core-api-design-security.md`, `core-attack-surface.md`, `core-data-flow-security.md`, `core-concurrency-security.md` | Universal standards for all code |
