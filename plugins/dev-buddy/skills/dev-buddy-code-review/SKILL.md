...
**API/CLI executors:** `Bash(run_in_background: true)` with one-shot-runner.ts using `--stage-type ralph-code-review`
...
4. If running under orchestrator: reset affected unit tasks to `in_progress`
