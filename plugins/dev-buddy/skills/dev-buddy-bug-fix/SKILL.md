...
> **SYNC NOTE:** This section is synchronized with `dev-buddy-feature-implement/SKILL.md`. Any changes here MUST be applied to both files. The only differences are pipeline-specific wording (4 lines: P2a NOTE, P2e fix note, aggregation notes field, and OVERALL GOAL context label).
