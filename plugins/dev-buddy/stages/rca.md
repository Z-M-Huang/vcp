---
stage: rca
description: Autonomously diagnose bugs through systematic fault isolation and root cause analysis
...
- `reviewer` — string, your model identifier
- `bug_report` — object (see Output Format below)
- `root_cause` — object (see Output Format below)
- `impact_analysis` — object (see Output Format below)
- `fix_constraints` — object (see Output Format below)
- `recommended_approach` — object (see Output Format below)
