...
- **[git-doc-mcp](https://github.com/Z-M-Huang/git-doc-mcp)** v0.2.1+ — the MCP server that serves the manifest. Installed automatically via `npx` when the MCP server starts.
