...
3. Ask whether to generate READMEs for all candidates or select specific ones using the interaction mode returned by MCP guidance.
...
4. Ask the user to accept, edit, or skip the proposed README using the interaction mode returned by MCP guidance.
