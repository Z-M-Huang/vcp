 ...
 *
 * Used by:
 * - plugins/vcp/hooks/security-context.ts (SessionStart hook)
 * - /vcp-context skill (via plugins/vcp/lib/generate-context.ts CLI shim)
 *
...
import type { VcpConfig } from "@vcp-lib/config/types";
...
export type { VcpConfig } from "@vcp-lib/config/types";
