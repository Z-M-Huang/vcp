 ...
 *
 * Reads .vcp/config.json (project) and ~/.vcp/config.json (global), fetches
 * the standards manifest, resolves applicable standards (with ignores
 * applied), and outputs structured JSON for skills to consume.
 *
 * Usage: bun run @vcp-lib/config/project [project-root]
 *
