...
- **标准从可变的 `main` 分支获取：** Skill 从 `https://raw.githubusercontent.com/.../main/...` 获取标准，这是可变的。强制推送或仓库被入侵可能改变所有用户收到的内容。当 VCP 达到 v1.0 时，标准将锚定到标记版本。对于 v0.2.15，在标准仍在编写期间，始终获取最新版本是有意的行为。
