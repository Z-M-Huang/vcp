...
2. **On-demand scanning** — Skills (`/vcp-audit`, `/vcp-dependency-check`, `/vcp-pre-commit-review`, `/vcp-review-tests`) scan code against 40 standards across 12 scopes
...
- `standards/` — AI-optimized markdown standards (40 files across 12 scopes, flat layout with `{scope}-{topic}.md` naming)
